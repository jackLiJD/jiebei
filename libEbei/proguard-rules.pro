...
-keep class * extends com.framework.core.db.IdEntity{*;}
-keep class com.framework.core.network.entity.ApiResponse{*;}

# webView 混淆keep规则
-keepclassmembers class com.framework.core.activity.HTML5WebView {
  public *;
}
-keepattributes *Annotation*
-keepattributes *JavascriptInterface*
...
-keep class com.framework.core.ui.AlaWebView$AlaWebViewData{
    public *;
}
-keep class com.framework.core.ui.AlaWebView{
    public *;
}
...
# 3D 地图 V5.0.0之前：
 ...
 #    3D 地图 V5.0.0之后：
  ...
  #   定位
    -keep class com.amap.api.com.framework.core.location.**{*;}
 ...
 #    2D地图
  ...
  # GlideModule
  -keepnames class com.framework.core.config.CustomCachingGlideModule{}
...
-keep class com.ald.xgcredit.update.UpdateManager
-keep class com.ald.xgcredit.receiver.SDKReceiver

-keep class com.ala.amount.**{*;}
