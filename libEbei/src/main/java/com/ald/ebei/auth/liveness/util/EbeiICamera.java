...
public class EbeiICamera {
    ...
    public RelativeLayout.LayoutParams getLayoutParam() {
        ...
        float scale = Math.min(EbeiScreen.mWidth * 1.0f / previewSize.height,
                EbeiScreen.mHeight * 1.0f / previewSize.width);
    ...
    public RelativeLayout.LayoutParams getParams(Camera camera) {
        ...
        // Log.w("ceshi", "EbeiScreen.mWidth===" + EbeiScreen.mWidth +
        // ", EbeiScreen.mHeight===" + EbeiScreen.mHeight);
        // 注意Screen是否初始化
        Camera.Size bestPreviewSize = calBestPreviewSize(camPara,
                EbeiScreen.mWidth, EbeiScreen.mHeight);
        cameraWidth = bestPreviewSize.width;
        cameraHeight = bestPreviewSize.height;
