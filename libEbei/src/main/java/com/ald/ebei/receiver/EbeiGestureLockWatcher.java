 ...
 * 修订历史：
 */
public class EbeiGestureLockWatcher {
    static final String TAG = "EbeiGestureLockWatcher";
    ...
    public EbeiGestureLockWatcher(Context context) {
        mContext = context;
    ...
    class InnerReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // if (reason != null) {
            // EbeiLogger.e(TAG, "action:" + action + ",reason:" + reason);
            // if (mListener != null) {
            // if (SYSTEM_DIALOG_REASON_HOME_KEY.equals(reason)) {
            // // 短按Home键
            // EbeiLogger.i(TAG, "短按Home键");
            // } else if (SYSTEM_DIALOG_REASON_RECENT_APPS.equals(reason)) {
            // // 长按Home键 或者 activity切换键
            // EbeiLogger.i(TAG, "长按Home键 或者 activity切换键");
            // } else if (SYSTEM_DIALOG_REASON_LOCK.equals(reason)) {
            // // 锁屏
            // EbeiLogger.i(TAG, "锁屏");
            // } else if (SYSTEM_DIALOG_REASON_ASSIST.equals(reason)) {
            // // samsung 长按Home键
            // EbeiLogger.i(TAG, " 长按Home键");
            // }
            // }
            // }
            // }
