...
import com.ald.ebei.util.EbeiUtils;
 ...
 * Created by ywd on 2017/11/16.
 */

public class EbeiMarqueeView extends ViewFlipper {
    ...
    public EbeiMarqueeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (typedArray.hasValue(R.styleable.MarqueeViewStyle_mvTextSize)) {
            ...
            textSize = EbeiUtils.px2sp(context, textSize);
        }
    ...
    private void startWithFixedWidth(String notice, @AnimRes int inAnimResId, @AnimRes int outAnimResID) {
        ...
        int width = EbeiUtils.px2dip(getContext(), getWidth());
        if (width == 0) {
    ...
    public void startWithList(List<? extends CharSequence> notices, @AnimRes int inAnimResId, @AnimRes int outAnimResID) {
        if (EbeiUtils.isEmpty(notices)) return;
        setNotices(notices);
        start(inAnimResId, outAnimResID);
    }
