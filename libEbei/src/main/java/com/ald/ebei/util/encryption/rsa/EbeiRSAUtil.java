package com.ald.ebei.util.encryption.rsa;
 ...
 * 修订历史：
 */
public final class EbeiRSAUtil {
    // 算法类别
    ...
    ///////////////////////////////////////////////////////////////////////////
    // 公钥PEM证书文件路径
    private static final String PUB_PEM_PATH    = EbeiRSAUtil.class.getResource("/").getPath() + "public_key.pem";
    // 私钥PEM证书文件路径
    private static final String PRI_PEM_PATH    = EbeiRSAUtil.class.getResource("/").getPath() + "pkcs8_private_key.pem";
    ///////////////////////////////////////////////////////////////////////////
    // PEM证书字符串
    ///////////////////////////////////////////////////////////////////////////
    ...
    public static void main(String[] args) {
        try {
            ...
            String base64Encrypt = EbeiBase64Util.encode(encrypt);
            System.out.println("Base64加密后: " + base64Encrypt);
            // 加"RSA加密结果"进行BCD加密
            String bcdEncrypt = EbeiBCDUtil.bcd2Str(encrypt);
            ...
            byte[] base64Decrypt = decryptData(EbeiBase64Util.decode(base64Encrypt), decryptKey);
            System.out.println("Base64解密后: " + new String(base64Decrypt));
            // 对"RSA解密结果"进行BCD解密
            byte[] bcdData = bcdEncrypt.getBytes();
            byte[] bcdDecrypt = decryptData(EbeiBCDUtil.ASCII_To_BCD(bcdData, bcdData.length), decryptKey);
            ...
            byte[] decr = decryptData(EbeiBase64Util.decode(dec), privateKey);
    ...
    public static PublicKey loadPublicKey(String publicKeyStr) throws Exception {
        try {
            byte[] buffer = EbeiBase64Util.decode(publicKeyStr);
            KeyFactory keyFactory = KeyFactory.getInstance(ALGORITHM);
    ...
    public static PrivateKey loadPrivateKey(String privateKeyStr) throws Exception {
        try {
            byte[] buffer = EbeiBase64Util.decode(privateKeyStr);
            KeyFactory keyFactory = KeyFactory.getInstance(ALGORITHM);
            // X509EncodedKeySpec keySpec = new X509EncodedKeySpec(buffer);
    ...
    public static void printPublicKeyInfo(PublicKey publicKey) {
        ...
        System.out.println("PublicEncoded=" + EbeiBase64Util.encode(rsaPublicKey.getEncoded()));
    }
    ...
    public static void printPrivateKeyInfo(PrivateKey privateKey) {
        ...
        System.out.println("PrivatecEncoded=" + EbeiBase64Util.encode(rsaPrivateKey.getEncoded()));
    }
}
