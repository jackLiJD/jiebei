 ...
 * @param <ResultT>
 */
public abstract class EbeiSafeAsyncTask<ResultT> implements Callable<ResultT> {
    private static final String TAG               = "EbeiSafeAsyncTask";
     ...
     */
    public EbeiSafeAsyncTask(Handler handler) {
     ...
     */
    public EbeiSafeAsyncTask(Executor executor) {
        this.executor = executor;
    }

    public EbeiSafeAsyncTask(Handler handler, Executor executor) {
        this.handler = handler;
        this.executor = executor;
    }
    ...
    public EbeiSafeAsyncTask<ResultT> executor(Executor executor) {
        this.executor = executor;
        return this;
    }
    ...
    public EbeiSafeAsyncTask<ResultT> handler(Handler handler) {
        this.handler = handler;
        return this;
    }
    ...
    protected void onThrowable(Throwable t) throws RuntimeException {
        EbeiLogger.e(TAG, "Throwable caught during background processing", t);
    }
    ...
    public static class Task<ResultT> implements Callable<Void> {
        protected EbeiSafeAsyncTask<ResultT> parent;
        protected Handler handler;

        public Task(EbeiSafeAsyncTask<ResultT> parent) {
            this.parent = parent;
