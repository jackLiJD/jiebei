...
import com.ald.ebei.ui.ref.EbeiRefObject;
import com.ald.ebei.util.encryption.des.EbeiThreeDESUtil;
import com.alibaba.fastjson.JSON;
import com.ald.ebei.ui.ref.EbeiRefException;
...
public class EbeiSPUtil {
    ...
    private EbeiSPUtil() {
        context = EbeiConfig.getContext();
        sp = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
    }

    public static EbeiSPUtil getInstance() {
        return SPUtilInstance.instance;
    }

    private static class SPUtilInstance {
        static EbeiSPUtil instance = new EbeiSPUtil();
    }
    ...
    public static boolean setValue(String key, Object value) {
        Editor edit = EbeiSPUtil.getInstance().getSp().edit();
    ...
    public static boolean getBoolean(String key, boolean defaultValue) {
        return EbeiSPUtil.getInstance().getSp().getBoolean(key, defaultValue);
    }
    ...
    public static String getString(String key, String defaultValue) {
        return EbeiSPUtil.getInstance().getSp().getString(key, defaultValue);
    }
    ...
    public static Float getFloat(String key, float defaultValue) {
        return EbeiSPUtil.getInstance().getSp().getFloat(key, defaultValue);
    }
    ...
    public static int getInt(String key, int defaultValue) {
        return EbeiSPUtil.getInstance().getSp().getInt(key, defaultValue);
    }
    ...
    public static long getLong(String key, long defaultValue) {
        return EbeiSPUtil.getInstance().getSp().getLong(key, defaultValue);
    }
    ...
    public static boolean remove(String key) {
        Editor editor = EbeiSPUtil.getInstance().getSp().edit();
        editor.remove(key);
    ...
    public static boolean contains(String key) {
        return EbeiSPUtil.getInstance().getSp().contains(key);
    }
    ...
    public static Map<String, ?> getAll() {
        return EbeiSPUtil.getInstance().getSp().getAll();
    }
    ///////////////////////////////////////////////////////////////////////////
    // Object 以参数名的形式存入SP
    ///////////////////////////////////////////////////////////////////////////
    ...
    public static void setObject(Object obj) {
        try {
            EbeiRefObject object = EbeiRefObject.wrap(obj);
            List<EbeiRefObject> list = object.getAll();
            for (EbeiRefObject field : list) {
    ...
    public static boolean setEntity(final Object obj, String make, boolean encryption) {
        if (obj != null) {
            ...
            if (innerKey != null) {
                ...
                if (encryption) {
                    try {
                        value = EbeiThreeDESUtil.encrypt(EbeiThreeDESUtil.SECRET_KEY, value);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    public static <T> T getEntity(final Class<T> clazz, String make, final T defaultValue, boolean decryption) {
        ...
        if (!TextUtils.isEmpty(innerKey)) {
            ...
            if (decryption) {
                try {
                    value = EbeiThreeDESUtil.decrypt(EbeiThreeDESUtil.SECRET_KEY, value);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
