 ...
 */
public final class EbeiHttpLoggingInterceptor implements Interceptor {
    ...
    public interface Logger {
        ...
        Logger DEFAULT = new Logger() {
            ...
            public void log(String message) {
                ...
                EbeiLogger.d("watermelon", "logger >> \n" + message);
            }
        };
    }

    public EbeiHttpLoggingInterceptor() {
        this(Logger.DEFAULT);
    }

    public EbeiHttpLoggingInterceptor(Logger logger) {
        this.logger = logger;
    }
     ...
     */
    public EbeiHttpLoggingInterceptor setLevel(Level level) {
        if (level == null)
...
//                }
        ...
        if (response.code() >= 400) {
            Looper.prepare();
//            EbeiUtils.toast(R.string.app_network_error);
            Looper.loop();
        }
