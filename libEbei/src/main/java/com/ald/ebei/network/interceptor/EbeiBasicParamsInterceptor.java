 ...
 * 修订历史：
 */
public class EbeiBasicParamsInterceptor implements Interceptor {
...
//    private Map map = null;
    private EbeiBasicParamsInterceptor() {
    }
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        String fwDeviceType = EbeiConfig.getContext().getResources().getString(R.string.fw_app_device_type);
        String fwDeviceId = EbeiConfig.getContext().getResources().getString(R.string.fw_app_device_id);
        String fwOsType = EbeiConfig.getContext().getResources().getString(R.string.fw_app_os_type);
        String fwPhoneType = EbeiConfig.getContext().getResources().getString(R.string.fw_app_phone_type);
        //白骑士设备指纹
        String fwBqsBlackbox = EbeiConfig.getContext().getResources().getString(R.string.fw_bqs_black_box);
        //AndroidID
        String fwAndroidID = EbeiConfig.getContext().getResources().getString(R.string.fw_android_id);
        ...
        headerBuilder.add(fwDeviceType, "android");
        headerBuilder.add(fwDeviceId, EbeiInfoUtils.getDeviceId());
        headerBuilder.add(fwOsType, "android_" + Build.VERSION.RELEASE);
        headerBuilder.add(fwPhoneType, Build.MODEL);
        headerBuilder.add("Authorization", getToken());
        headerBuilder.add(fwBqsBlackbox, BqsDF.getTokenKey());
        headerBuilder.add(fwAndroidID, EbeiInfoUtils.getAndroidId(EbeiConfig.getContext()));
        // 签名规则
        String signRule = getSignRule(fwVersion, fwNetType, fwTime, fwUserName, ts);
        String requestUrlPath = request.url().encodedPath();
        if (!requestUrlPath.contains("nnl")) {
            //需要token参数加密
            signRule += getToken();
        }
...
//            Map paramsMap = JSONObject.parseObject(postBodyJsonString.replace("&", ","));
    ...
    private String getUserName() {
        return EbeiConfig.getEbeiAccountProvider().getUserName();
    }
    ...
    public static class Builder {
        EbeiBasicParamsInterceptor interceptor;

        public Builder() {
            interceptor = new EbeiBasicParamsInterceptor();
        }
        ...
        public EbeiBasicParamsInterceptor build() {
            return interceptor;
        }
